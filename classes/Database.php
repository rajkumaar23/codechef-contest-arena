...
class Database
{
    ...
    {
        $migrations = [
            "CREATE TABLE IF NOT EXISTS `contests` (`code` text COLLATE utf8_unicode_ci NOT NULL,`name` text COLLATE utf8_unicode_ci NOT NULL,`isParent` int(11) NOT NULL DEFAULT '0',`startDate` datetime NOT NULL,`endDate` datetime NOT NULL,`banner` text COLLATE utf8_unicode_ci,`lastUpdated` datetime DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;",
            "CREATE TABLE IF NOT EXISTS `languages` (`name` varchar(255) NOT NULL,`lastUpdated` datetime NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1;",
